...
Component({
  ...
  methods: {
    ...
    creat_order() {
      ...
      wx.navigateTo({                                                                       //进入聊天室
        url: '/pages/order_form/order_form?goods_id=' + this.data.goodId 
      })
    },
    qwe(){
     console.log(this.data.opId,"123",this.data.sellerId)
    },
    ...
    mergeCommonCriteria(criteria) {
      ...
      let goodPic = this.data.goodPic
      let goodId = this.data.goodId
      let sellerId = this.data.sellerId
      console.log("66666666",groupId,this.data.groupId,"999999",opId,this.data.opId,this.data.goodId,sellerId)
      return {
    ...
    async onConfirmSendText(e) {
      this.try(async () => {
        ...
        console.log("000000",this.data.opId)
        const { collection } = this.properties
        const db = this.db
        const _ = db.command
  ...
  ready() {
    ...
    this.initRoom()
    console.log("000",this.data.openId)
